...
This application is not intended to replace a regular personal calculator.  It is a set of equations/calculators that I have had to use from time to time.  

This project is written with React.js (their boilerplate README is below).

To run this project, you'll need [npm](https://www.npmjs.com/get-npm).  Once you have npm, clone this repository, and in your terminal, navigate to the clone location and use the command
 
 `npm start`
 
 to get it started.  The app will open in a new web browser window.  All other npm commands are included below.
